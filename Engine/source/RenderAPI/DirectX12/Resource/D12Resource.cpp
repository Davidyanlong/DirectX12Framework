...
namespace Engine {
	D12Resorce::~D12Resorce()
	{
		Release();
	}
	void D12Resorce::Initialize(ID3D12Device* pDevice, const unsigned int numBytes, D3D12_HEAP_TYPE heapType, D3D12_RESOURCE_STATES initialState)
	{
